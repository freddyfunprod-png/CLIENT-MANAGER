    ...
    try:
        ...
        async with browser_session(timezone_id=body.timezone) as (ctx, page):
            if source_type == 'instagram':
                ...
                urls = await collect_instagram_urls(page, category_query, body.city, body.country, body.limit)
                ...
                urls = await collect_place_urls(
                    page, category_query, body.city, body.country, body.limit
                )
                ...
                for i, url in enumerate(urls, start=1):
                    ...
                    passes, reason = passes_filters(result, real_web)
